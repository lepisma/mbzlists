  ...
  <section class="max-w-4xl p-8 space-y-10">
    ...
    <div class="grid grid-cols-1">
      <div>
        ...
        <div class="text-gray-600 dark:text-gray-200">
          Play songs on YouTube or Spotify (other services to be added). Or just download the XSPF playlist and use <a class="anchor" href="https://resolvers.mbzlists.com" target="_blank">content resolvers</a> to play on your player of choice.
        </div>
      </div>
    </div>
    <div class="grid grid-cols-1">
